############
# HCSR04.py a Micropython driver for the HCSR04 ultrasound telemeter.
#
...
class HCSR04:
	...
	With temperature correction using a TMP36 sensor:
	tmp36 = TMP36(32)
	usrange = HCSR04(12, 13, tmp36=tmp36)

	With temperature correction using a BME280 sensor:
	bme = BME280(machine.I2C(1))
	usrange = HCSR04(12, 13, bme280=bme)
	"""
